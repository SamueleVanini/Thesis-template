...
\intro{Nel corso di questo capitolo presento un resoconto del progetto, descrivendone gli aspetti nel dettaglio. Oltre a ciò, illustro le metodologie di lavoro utilizzate e le scelte
che ho preso per la realizzazione delle componenti ritenute più rilevanti o critiche.}
...
\end{itemize}
%**************************************************************
\subsection{Attività pianificate}
...
\begin{figure}[!h] 
    \centering 
    \includegraphics[width=0.9\columnwidth]{azienda/flusso_RFID.jpeg} 
